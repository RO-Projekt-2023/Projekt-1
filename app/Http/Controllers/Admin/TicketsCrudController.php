...
class TicketsCrudController extends CrudController
{
    ...
    {
        CRUD::setValidation(TicketsRequest::class);
        ...
        CRUD::addField([
            ...
            'label'      => 'Type',
            'type'       => 'select',
            'entity'     => 'event', // The Eloquent model for the related table
            'attribute'  => 'name', // The column to display in the select
            'model'      => 'App\Models\Events', // The related model
        ]);
